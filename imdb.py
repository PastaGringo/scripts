...
class IMDBBase(Automation, RSS):
    ...
    charts = {
		...
		'dvdbluray': {
            'order': 4,
            'name': 'IMDB - New on DVD & Blu-ray per week',
    ...
    'groups': [
        ...
        },
        {
            ...
            'options': [
				...
				{
                    'name': 'automation_charts_dvdbluray',
                    'type': 'bool',
                    'label': 'New on DVD & Blu-ray per week',
                    'description': 'New on DVD & Blu-ray <a href="http://www.imdb.com/sections/dvd/" target="_blank">per week</a>',
                    'default': False,
                },
            ],
        },
