...
ln -s /etc/php/7.0/mods-available/yaml.ini /etc/php/7.0/fpm/conf.d/20-yaml.ini sudo ln -s /etc/php/7.0/mods-available/yaml.ini /etc/php/7.0/cli/conf.d/20-yaml.ini
...
nginx -t sudo /etc/init.d/nginx restart
cd /var/www/html/grav
./bin/gpm install admin
chown -R www-data:www-data /var/www/html/grav sudo chmod -R 755 /var/www/html/grav
cd /var/www/html/grav 
